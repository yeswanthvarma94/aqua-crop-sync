...
create policy "Only owners can update their account"
  on public.accounts for update
  to authenticated
  using (public.is_account_owner(id, auth.uid()));

create policy "Only owners can delete their account"
...
create policy "Only owners can insert locations"
  on public.locations for insert
  to authenticated
  with check (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can update locations"
  on public.locations for update
  to authenticated
  using (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can delete locations"
...
create policy "Only owners can insert tanks"
  on public.tanks for insert
  to authenticated
  with check (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can update tanks"
  on public.tanks for update
  to authenticated
  using (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can delete tanks"
...
create policy "Only owners can insert tank crops"
  on public.tank_crops for insert
  to authenticated
  with check (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can update tank crops"
  on public.tank_crops for update
  to authenticated
  using (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can delete tank crops"
...
create policy "Only owners can update stocks"
...
create policy "Only owners can insert material logs"
  on public.material_logs for insert
  to authenticated
  with check (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can update material logs"
  on public.material_logs for update
  to authenticated
  using (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can delete material logs"
...
create policy "Only owners can insert expenses"
...
create policy "Only owners can update pending changes"
  on public.pending_changes for update
  to authenticated
  using (public.is_account_owner(account_id, auth.uid()));

create policy "Only owners can delete pending changes"
